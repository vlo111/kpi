...
import { IProfessionalSkills } from '../../../../types/api/application/applicationForm';

const ProfessionalSkills: React.FC<IProfessionalSkills> = ({
  professionalSkills
}) => {
  return (
    <DetailsContainer>
      ...
      {professionalSkills?.questions?.map((question) => (
